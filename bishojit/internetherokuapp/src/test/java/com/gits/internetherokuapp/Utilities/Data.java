package com.gits.internetherokuapp.Utilities;

public class Data {

    public static final String PHONE_NUMBER ="01400220509";
    ...
    public static final String AB_TEST_VARIATION = "A/B Test Variation";
    ...
    public static final String FILE_UPLOAD_PATH = "C:\\Users\\Bisho\\Downloads\\test (3).txt";


    //File Upload Corresponding Page
    public static final String FILE_UPLOAD_CORRESPONDING_HEADER = "File Uploader";

    //Forgot Password
    public static final String FORGOT_PASSWORD_LINK = "forgot_password";
    public static final String FORGOT__PASSWORD_HEADER = "forgot password";
    public static final String FORGOT_PASSWORD_PAGE_EMAIL = "bishojitchakrobortty3@gmail.com";
    ...
    public static final String INPUTS_TEXT = "Hi,my name is Bishojit.god make my wish fulfill.your iframe is working and inputs is working.";
