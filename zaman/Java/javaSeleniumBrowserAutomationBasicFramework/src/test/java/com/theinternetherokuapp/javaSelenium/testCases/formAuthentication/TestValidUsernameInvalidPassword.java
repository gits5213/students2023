...
public class TestValidUsernameInvalidPassword {
    ...
    public  void invalidUsernameValidPassword() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector(locators.locatorPassword)).sendKeys(data.invalidPassword);
        ...
        Assert.assertEquals(data.invalidLoginMessageForPassword,actualLoginErrorMessage);
